...
/**
 * Servlet implementation class DisplayDistrictForVoterServlet
 */
@WebServlet("/DisplayDistrictForVoterServlet")
public class DisplayDistrictForVoterServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayDistrictForVoterServlet() {
        super();
    }
