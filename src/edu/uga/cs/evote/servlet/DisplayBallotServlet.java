...
/**
 * Servlet implementation class DisplayBallotServlet
 */
@WebServlet("/DisplayBallotServlet")
public class DisplayBallotServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayBallotServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {			
			...
			writer.println("var select = document.getElementById('chooseBallot');");
