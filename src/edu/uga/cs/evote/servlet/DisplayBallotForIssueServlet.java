...
/**
 * Servlet implementation class DisplayBallotForIssueServlet
 */
@WebServlet("/DisplayBallotForIssueServlet")
public class DisplayBallotForIssueServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayBallotForIssueServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {			
			...
			writer.println("var select = document.getElementById('chooseBallotForIssue');");
