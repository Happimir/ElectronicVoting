...
/**
 * Servlet implementation class DisplayBallotForOpenServlet
 */
@WebServlet("/DisplayBallotForOpenServlet")
public class DisplayBallotForOpenServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayBallotForOpenServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {			
			...
			writer.println("var select = document.getElementById('chooseBallotForOpen');");
