...
/**
 * Servlet implementation class UpdateVoterProfileServlet
 */
@WebServlet("/UpdateVoterProfileServlet")
public class UpdateVoterProfileServlet extends HttpServlet {
     ...
     */
    public UpdateVoterProfileServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("ssid" + ssid);
	      ...
	      try {
	          long voter_id = logicLayer.updateVoter( old_username, first_name, last_name, email, address, district);
	          writer.println("<script type=text/javascript>");
	    	  ...
	    	  e.printStackTrace();
	    	  writer.println("<script type=text/javascript>");
	    	  writer.println("alert('Exception! Error updating voter.');");
	    	  writer.println("</script>"); 
	      }
