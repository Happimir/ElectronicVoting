...
/**
 * Servlet implementation class DisplayDistrictServlet
 */
@WebServlet("/DisplayDistrictServlet")
public class DisplayDistrictServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayDistrictServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {			
			...
			writer.println("var select = document.getElementById('chooseDistrict');");
