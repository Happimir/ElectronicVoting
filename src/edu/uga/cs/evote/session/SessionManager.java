...
public class SessionManager
{
            ...
            throws EVException 
    {
        ...
        try {
            ...
            throw new EVException( "SessionManager.login: Unable to get a database connection" );
        }
            ...
            throws EVException
    {
        ...
        String ssid = secureHash( "eVote" + System.nanoTime() );
            ...
            throws EVException
    {
	    ...
	    //            log.error( "SessionManager.removeSession: cannot close connection", sqe );
            throw new EVException( "SessionManager.removeSession: Cannot close connection" );
        } // try
